...
const path_utils_1 = require("./src/utils/path-utils");
console.log('Testing enhanced curve detection with fill area...');
// Test 1: Closed rectangle
const rectPath = (0, path_utils_1.parsePathString)('M 50 50 L 150 50 L 150 150 L 50 150 Z');
...
const result1 = (0, path_utils_1.findSubPathAtPointAdvanced)(rectPath, pointInside, {
    tolerance: 20,
    includeFill: true,
    includeStroke: true
});
...
const result2 = (0, path_utils_1.findSubPathAtPointAdvanced)(rectPath, pointNearEdge, {
    tolerance: 20,
    includeFill: true,
    includeStroke: true
});
...
const result3 = (0, path_utils_1.findSubPathAtPointAdvanced)(rectPath, pointFar, {
    tolerance: 20,
    includeFill: true,
    includeStroke: true
});
...
const linePath = (0, path_utils_1.parsePathString)('M 50 50 L 150 50');
// Point "inside" the line area (but line is open)
const pointOnLine = { x: 100, y: 50 };
const result4 = (0, path_utils_1.findSubPathAtPointAdvanced)(linePath, pointOnLine, {
    tolerance: 5,
    includeFill: true,
    includeStroke: true
});
...
const result5 = (0, path_utils_1.findSubPathAtPointAdvanced)(rectPath, pointInside, {
    tolerance: 20,
    includeFill: false,
    includeStroke: true
});
...
// Test 4: Curved path
const curvePath = (0, path_utils_1.parsePathString)('M 50 100 C 50 50, 150 50, 150 100 C 150 150, 50 150, 50 100 Z');
const pointInCurve = { x: 100, y: 100 };
const result6 = (0, path_utils_1.findSubPathAtPointAdvanced)(curvePath, pointInCurve, {
    tolerance: 20,
    includeFill: true,
    includeStroke: true
});
