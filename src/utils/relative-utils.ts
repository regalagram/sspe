 ...
 */
export function toRelativeCommand(command: SVGCommand, previousPoint: Point): SVGCommand {
 ...
 */
export function toAbsoluteCommand(command: SVGCommand, previousPoint: Point): SVGCommand {
 ...
 */
export function getAbsolutePositionFromPrevious(command: SVGCommand, previousPoint: Point): Point {
 ...
 */
export function convertSubPathCoordinates(subPath: SVGSubPath, toRelative: boolean): SVGSubPath {
  const convertedCommands: SVGCommand[] = [];
  let currentPoint: Point = { x: 0, y: 0 };
  
  for (let i = 0; i < subPath.commands.length; i++) {
    const command = subPath.commands[i];
    let convertedCommand: SVGCommand;
 ...
 */
export function isRelativeCommand(command: SVGCommand): boolean {
 ...
 */
export function getRelativeCommandType(commandType: string): string {
 ...
 */
export function getAbsoluteCommandType(commandType: string): string {
 ...
 */
export function getSubPathFinalPosition(subPath: SVGSubPath, startPoint: Point = { x: 0, y: 0 }): Point {
 ...
 */
export function convertSubPathCoordinatesInContext(
  subPath: SVGSubPath, 
  toRelative: boolean, 
  pathStartPoint: Point = { x: 0, y: 0 },
  isFirstSubPath: boolean = true
): SVGSubPath {
  const convertedCommands: SVGCommand[] = [];
  let currentPoint: Point = { ...pathStartPoint };
  let subPathStartPoint: Point = { ...pathStartPoint };
 ...
 */
export function convertPathCoordinates(subPaths: SVGSubPath[], toRelative: boolean): SVGSubPath[] {
  const convertedSubPaths: SVGSubPath[] = [];
  let currentPathPosition: Point = { x: 0, y: 0 };
 ...
 */
export function debugConvertPathCoordinates(subPaths: SVGSubPath[], toRelative: boolean): void {
